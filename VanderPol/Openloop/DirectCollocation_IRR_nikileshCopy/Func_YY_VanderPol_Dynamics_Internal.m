...
function const = Func_YY_VanderPol_Dynamics_Internal(X_in,U,p,t,data)
global ADiGator_Func_YY_VanderPol_Dynamics_Internal
if isempty(ADiGator_Func_YY_VanderPol_Dynamics_Internal); ADiGator_LoadData(); end
Gator1Data = ADiGator_Func_YY_VanderPol_Dynamics_Internal.Func_YY_VanderPol_Dynamics_Internal.Gator1Data;
Gator2Data = ADiGator_Func_YY_VanderPol_Dynamics_Internal.Func_YY_VanderPol_Dynamics_Internal.Gator2Data;
...
cada1td1dY = cada2td1;
cada1td1(Gator1Data.Index11) = cada2f4;
...
cada1td1 = sparse(Gator1Data.Index19,Gator1Data.Index20,X_vect.dY,202,202);
cada1td1 = data.map.A*cada1td1;
cada1td1 = cada1td1(:);
cada2f1 = cada1td1(Gator1Data.Index21);
cada1f3dY = full(cada2f1);
cada1f3 = data.map.A*X_vect.f;
cada1f4dYdY = dynF.dYdY(Gator2Data.Index8);
cada1f4dY = dynF.dY(Gator1Data.Index22);
cada1f4 = dynF.f.';
cada1tempdY = delta_t.dY(Gator1Data.Index23);
cada1tf1dY = cada1f4dY(Gator2Data.Index9);
cada1tf1 = cada1f4(Gator1Data.Index24);
cada1td1 =  zeros(808,1);
cada2f1dY = cada1tf1dY;
cada2f1 = cada1tf1(:);
cada2tf1 = cada1tempdY(Gator2Data.Index10);
cada2f2dY = cada2tf1(:).*cada2f1dY;
cada2f2 = cada2f1.*cada1tempdY;
cada1td1dY = cada2f2dY;
cada1td1(Gator1Data.Index25) = cada2f2;
cada2f1 = cada1td1(Gator1Data.Index26);
cada2tempdY = delta_t.dY(Gator2Data.Index11);
cada2tf1 = cada1f4dY(Gator2Data.Index12);
cada2td1 = zeros(1010,1);
cada2td1(Gator2Data.Index13) = cada2tf1(:).*cada2tempdY;
cada2td1(Gator2Data.Index14) = cada2td1(Gator2Data.Index14) + delta_t.f.*cada1f4dYdY;
cada2f2dY = cada2td1;
cada2f2 = delta_t.f*cada1f4dY;
cada2f3dY = cada2f2dY;
cada2f3 = cada2f1 + cada2f2;
cada2td1 = zeros(1818,1);
cada2td1(Gator2Data.Index15) = cada2f3dY;
...
cada1td1dY = cada1f7dYdY(Gator2Data.Index18);
cada1td1 = sparse(Gator1Data.Index27,Gator1Data.Index28,cada1f7dY,202,305);
cada2td1 = sparse(Gator2Data.Index19,Gator2Data.Index20,cada1td1dY,202,1414);
...
cada1td1 =  zeros(1700,1);
cada1td1(Gator1Data.Index30) = cada1f3dY;
...
cada1td1 =  zeros(1702,1);
cada1td1(Gator1Data.Index32) = cada1f2dY;
cada1td1dY = cada1f9dYdY;
cada1td1(Gator1Data.Index33) = cada1f9dY;
...
const.dY_size = [202 305];
const.dY_location = Gator1Data.Index34;
const.dYdY_size = [const.dY_size,305];
const.dYdY_location = [const.dY_location(Gator2Data.Index23,:), Gator2Data.Index24];
end


function ADiGator_LoadData()
global ADiGator_Func_YY_VanderPol_Dynamics_Internal
ADiGator_Func_YY_VanderPol_Dynamics_Internal = load('Func_YY_VanderPol_Dynamics_Internal.mat');
return
end