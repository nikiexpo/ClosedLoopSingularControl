function [problem,guess] = VanderPol_OL
%VanderPol_OL - Van der Pol Problem in Openloop
%
% Syntax:  [problem,guess] = VanderPol_OL
%
% Outputs:
...
problem.time.tf_min=16*2;     
problem.time.tf_max=16*2; 
guess.tf=16*2;
