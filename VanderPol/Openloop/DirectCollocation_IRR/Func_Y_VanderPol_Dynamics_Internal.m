...
function const = Func_Y_VanderPol_Dynamics_Internal(X_in,U,p,t,data)
global ADiGator_Func_Y_VanderPol_Dynamics_Internal
if isempty(ADiGator_Func_Y_VanderPol_Dynamics_Internal); ADiGator_LoadData(); end
Gator1Data = ADiGator_Func_Y_VanderPol_Dynamics_Internal.Func_Y_VanderPol_Dynamics_Internal.Gator1Data;
...
cada1td1(Gator1Data.Index10) = cada1f7(:).*cada1f5dY;
cada1td1(Gator1Data.Index11) = cada1td1(Gator1Data.Index11) + cada1f5(:).*cada1f7dY;
cada1f8dY = cada1td1;
cada1f8 = cada1f5.*cada1f7;
cada1f9dY = 0.8.*cada1f1dY;
cada1f9 = 0.8*cada1f1;
cada1td1 = cada1f8dY;
cada1td1(Gator1Data.Index12) = cada1td1(Gator1Data.Index12) + -cada1f9dY;
cada1f10dY = cada1td1;
cada1f10 = cada1f8 - cada1f9;
cada1td1 = zeros(303,1);
cada1td1(Gator1Data.Index13) = cada1f10dY;
cada1td1(Gator1Data.Index14) = cada1td1(Gator1Data.Index14) + U.dY;
cada1f11dY = cada1td1;
cada1f11 = cada1f10 + U.f;
cada1td1 = zeros(404,1);
cada1td1(Gator1Data.Index15) = cada1f11dY;
cada1td1(Gator1Data.Index16) = cada1f4dY(Gator1Data.Index17);
dynF.dY = cada1td1;
dynF.f = cada1f4;
dynF.f(:,2) = cada1f11;
...
cada1td1 = cada1td1(:);
cada1f3dY = full(cada1td1(Gator1Data.Index21));
...
cada1td1(Gator1Data.Index25) = cada1tf1(:).*cada1tempdY;
cada1td1(Gator1Data.Index26) = cada1td1(Gator1Data.Index26) + delta_t.f.*cada1f4dY;
cada1f5dY = cada1td1;
...
cada1td1 = cada1td1(:);
cada1f8dY = full(cada1td1(Gator1Data.Index29));
cada1f8 = data.map.B*cada1f7;
cada1td1 = zeros(1700,1);
cada1td1(Gator1Data.Index30) = cada1f3dY;
cada1td1(Gator1Data.Index31) = cada1td1(Gator1Data.Index31) + cada1f8dY;
cada1f9dY = cada1td1;
...
global ADiGator_Func_Y_VanderPol_Dynamics_Internal
ADiGator_Func_Y_VanderPol_Dynamics_Internal = load('Func_Y_VanderPol_Dynamics_Internal.mat');
return
end