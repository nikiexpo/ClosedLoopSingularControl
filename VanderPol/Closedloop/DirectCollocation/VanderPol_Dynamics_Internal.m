function [dx] = VanderPol_Dynamics_Internal(x,u,p,t,vdat)
% Van der Pol Dynamics - Internal
%
% Syntax:  
...
dx(:,2) = 10*x2.*(0.21-1.2^2*x1)-0.8*x1+u; % simplified to 14.39999*x2.*(0.14583333-x1)-0.8*x1+u;
