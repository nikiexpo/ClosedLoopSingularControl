function [dx] = SIMBS_Dynamics_Internal(x,u,p,t,vdat)
% Single Infinite Machine Bus Dynamics - Internal
%
% Syntax:  
...
dx(:,2) = (vdat.Pm-vdat.D*x2)/2/vdat.H-vdat.Pe/2/vdat.H*sin(x1+vdat.dep).*u;
