function [problem,guess] = SIMBS_OL
%SIMBS - Single Infinite Machine Bus Problem (Openloop)
%
% Syntax:  [problem,guess] = SIMBS_OL
%
% Outputs:
...
% Settings file
problem.settings=@settings_SIMBS_OL;
...
problem.time.tf_min=4.5;     
problem.time.tf_max=4.5; 
guess.tf=4.5;
